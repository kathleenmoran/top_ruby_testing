...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_chocolate_milk) { described_class.new('chocolate milk') }

      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_chocolate_milk.type).to eq('chocolate milk')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(my_chocolate_milk.ounces).to eq(16)
      end
    end
  end
  ...
  describe '#full?' do
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_tea) { described_class.new('tea', 4) }
